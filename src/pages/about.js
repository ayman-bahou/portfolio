...
const about = () => {
    ...
    je suis <span className='font-bold'>Ayman BAHOU</span>, étudiant ingénieur en M1 spécialisé en développement logiciel. Je suis un passioné du développement Web et de programmation de façon générale.
</p>
